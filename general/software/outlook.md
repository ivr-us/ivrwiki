...
This setup walks you through logging into your University Mail in Outlook.

:::tip
If you have to access your Mail fast, use [Webmail](https://mail.uni-stuttgart.de)
:::

:::warning Correct Outlook version
Make sure to always use the Outlook installed with Microsoft Office, often called "Outlook **(classic)**". Never use "Outlook **(new)** as it is not compliant with GDPR and is missing features
:::
